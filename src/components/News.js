...
const News = (props)=>{
  ...
  useEffect(() => {
    document.title = `NewsPoint -  ${capitalize(props.category)}`;
    updateNews();
  }, [])
  ...
  return (
    <>
      <h1 className='text-center' style={{margin:'100px 0 40px 0'}}>NewsPoint - Top {capitalize(props.category)} Headlines</h1>
      {loading && <Spinner />}
