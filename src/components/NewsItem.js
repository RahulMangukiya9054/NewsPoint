    ...
    return (
      <div className='my-3'>
        <div className="card">
          ...
          <img src={props.imageUrl?props.imageUrl:"https://images.cnbctv18.com/wp-content/uploads/2023/08/Mobile-internet-1019x573.jpg"} className="card-img-top" alt="Sorry, Image Not Available"/>
